...
public class OrderMapper {
    ...
    OrderDTO toDTO (List<Order> orders){
        ...
        rootNumbers.stream().sorted();
        dto.setRootNumbers(rootNumbers);
        ...
        OrderStatus status = statusService.getOrderStatusByUserIdAndNumberIkea(userId, firstDateStartOrder.getNumberIkea());
